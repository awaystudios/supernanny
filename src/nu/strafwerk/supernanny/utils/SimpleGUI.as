...
/**		
 *  @modified June 8 2011 version 1.03 for ACNE
 * 
...
package nu.strafwerk.supernanny.utils 
{
	...
	public class SimpleGUI extends EventDispatcher
	{
		...
		public function SimpleGUI(target : DisplayObjectContainer, title : String = null, hotKey : * = null)
		{
			...
			_toggle.y = MARGIN + OFFSETY;
			
			_toolbar.x = MARGIN + OFFSETX;
			_toolbar.y = MARGIN + OFFSETY;
			
			_container.x = MARGIN + OFFSETX;
			_container.y = TOOLBAR_HEIGHT + (MARGIN * 2) +  OFFSETY;
		...
		private function initToolbar() : void
		{
			...
			_version = new Label();
			_version.text = "Settings"; //SimpelGUI v" + VERSION;
			_version.alpha = 0.5;
			...
			_toggle.graphics.beginFill(0x000000, 0.9);
...
{
	public function HUIRangeSlider() {} 
