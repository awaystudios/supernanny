package nu.strafwerk.supernanny.gamecomponents {
	 ...
	 * @author admin
	 */
	public class TreeThin extends GameObject {
		public function TreeThin(x : Number, z : Number, collisionRadius : Number, collisionName : String, debug : Boolean = false) {
			mesh = ShareAssets.instance.getMesh("treeThin", true);
			mesh.scale(0.15);
